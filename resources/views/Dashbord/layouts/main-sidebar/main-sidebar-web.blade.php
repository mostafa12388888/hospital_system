			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{route('Patient_details.index')}}">قائمة الفواتير</a></li>
                            <li><a class="slide-item" href="{{route('Patient_details.create')}}">المختبر</a></li>
                            <li><a class="slide-item" href="{{route('Patient_rayshow.patient')}}">الاشعة</a></li>
						</ul>
					</li>
					<li class="slide">
