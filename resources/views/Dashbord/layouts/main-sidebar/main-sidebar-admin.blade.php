<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('Dashbord/img/faces/6.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
				<li class="side-item side-item-category">{{trans('Dashbord\main_sidbar_trans.Main')}}</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ route('admin.dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">{{trans('Dashbord/main_sidbar_trans.index')}}</span><span class="badge badge-success side-badge">1</span></a>
					</li>
					<li class="side-item side-item-category">General</li>

					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{trans('Dashbord/main_sidbar_trans.sections')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('Sections_admin.index')}}">{{trans('Dashbord/main_sidbar_trans.show_all')}}</a></li>
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{route('Services_admin.index')}}">{{trans('main-sidebar_trans.Single_service')}}</a></li>
                    <li><a class="slide-item" href="{{ route('Services_ofer') }}">{{trans('main-sidebar_trans.group_services')}}</a></li>
			...
			<!-- start for patients -->
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M6.26 9L12 13.47 17.74 9 12 4.53z" opacity=".3"/><path d="M19.37 12.8l-7.38 5.74-7.37-5.73L3 14.07l9 7 9-7zM12 2L3 9l1.63 1.27L12 16l7.36-5.73L21 9l-9-7zm0 11.47L6.26 9 12 4.53 17.74 9 12 13.47z"/></svg><span class="side-menu__label">{{trans('Dashbord/patiants/patiants.patiants')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('Patients.index') }}">{{trans('Dashbord/patiants/patiants.patiants_show')}}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='avatar') }}">Avatar</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='breadcrumbs') }}">Breadcrumbs</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='buttons') }}">Buttons</a></li>		<li><a class="slide-item" href="{{ url('/' . $page='tabs') }}">Tabs</a></li>
						</ul>
					</li>
					<!-- end for patients -->
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('single_invoices')}}">{{trans('invoices.Single_service_bill')}}</a></li>
							<li><a class="slide-item" href="{{route('group_invoices') }}">{{trans('invoices.Groupe_invoices')}}</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="#">قائمه الكشوفات</a></li>

						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h15v3H5zm12 5h3v9h-3zm-7 0h5v9h-5zm-5 0h3v9H5z" opacity=".3"/><path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM8 19H5v-9h3v9zm7 0h-5v-9h5v9zm5 0h-3v-9h3v9zm0-11H5V5h15v3z"/></svg><span class="side-menu__label">{{trans('main-sidebar_trans.laboratoy')}}</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{route('laboratorie_employee.index') }}">{{trans('main-sidebar_trans.Staff_list')}}</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('appointmets.index') }}">قائمه المواعيد </a></li>
							<li><a class="slide-item" href="{{ route('appointments.approval') }}">قائمه المواعيد المواكده</a></li>
							<li><a class="slide-item" href="{{ route('appointments.keep_up') }}">قائمه المواعيد المنتهيه </a></li>
