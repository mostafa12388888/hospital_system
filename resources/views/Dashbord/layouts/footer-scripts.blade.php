...
<!-- JQuery min js -->
<script src="{{URL::asset('Dashbord/plugins/jquery/jquery.min.js')}}"></script>
<!-- Bootstrap Bundle js -->
<script src="{{URL::asset('Dashbord/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<!-- Ionicons js -->
<script src="{{URL::asset('Dashbord/plugins/ionicons/ionicons.js')}}"></script>
<!-- Moment js -->
<script src="{{URL::asset('Dashbord/plugins/moment/moment.js')}}"></script>

<!-- Rating js-->
<script src="{{URL::asset('Dashbord/plugins/rating/jquery.rating-stars.js')}}"></script>
<script src="{{URL::asset('Dashbord/plugins/rating/jquery.barrating.js')}}"></script>

<!--Internal  Perfect-scrollbar js -->
<script src="{{URL::asset('Dashbord/plugins/perfect-scrollbar/perfect-scrollbar.min.js')}}"></script>
<script src="{{URL::asset('Dashbord/plugins/perfect-scrollbar/p-scroll.js')}}"></script>
<!--Internal Sparkline js -->
<script src="{{URL::asset('Dashbord/plugins/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
<!-- Custom Scroll bar Js-->
<script src="{{URL::asset('Dashbord/plugins/mscrollbar/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<!-- right-sidebar js -->
<script src="{{URL::asset('Dashbord/plugins/sidebar/sidebar-rtl.js')}}"></script>
<script src="{{URL::asset('Dashbord/plugins/sidebar/sidebar-custom.js')}}"></script>
<!-- Eva-icons js -->
<script src="{{URL::asset('Dashbord/js/eva-icons.min.js')}}"></script>

@yield('js')
<!-- Sticky js -->
<script src="{{URL::asset('Dashbord/js/sticky.js')}}"></script>
<!-- custom js -->
