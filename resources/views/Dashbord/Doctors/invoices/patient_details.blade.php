                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    ...
                                                    @foreach($patient_rays as $patient_ray)
                                                        <tr>
                                                            ...
                                                            <td>{{$patient_ray->RayEmploy->name??'No Employee'}}</td>
                                                            @if($patient_ray->case)
                                                            ...
                                                            @if( $patient_ray->case==0)
                                                                ...
                                                                @else
                                                               <td> <a class="modal-effect btn btn-sm btn-warning"    href="{{route('invoices.show',$patient_ray->id)}}"><i class="fas fa-eye"></i></a></td>
                                                                @endif
                                                            @endif
                                                        </tr>
                                                        @include('Dashbord.doctors.invoices.edit_xray_conversion')
                                                        @include('Dashbord.doctors.invoices.deleted')
                                                    @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
                                                    ...
                                                    @foreach($patient_Laboratories as $patient_Laboratorie)
                                                        <tr>
                                                            ...
                                                            @if( $patient_Laboratorie->case==0)
                                                                ...
                                                                @else
                                                               <td> <a class="modal-effect btn btn-sm btn-warning"    href="{{route('Laboratories.show',$patient_Laboratorie->id)}}"><i class="fas fa-eye"></i></a></td>
                                                                @endif
                                                            @endif
                                                        </tr>
                                                        @include('Dashbord.doctors.invoices.edit_laboratorie_conversion')
                                                        @include('Dashbord.doctors.invoices.deleted_laboratorie')
                                                    @endforeach
                                                    </tbody>
                                                </table>
                                            </div>
