...
@section('content')
    ...
    <div class="demo-gallery">
        <ul id="lightgallery" class="list-unstyled row row-sm pr-0">
            ...
            <li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('Dashbord/img/Laboratory_Employee/'.$image->fileame)}}" data-src="{{URL::asset('Dashbord/img/Laboratory_Employee/'.$image->fileame)}}">
                <a href="{{URL::asset('Dashbord/img/Laboratory_Employee/'.$image->fileame)}}" target="_merge">
                    <img width="50px" height="350px" class="img-responsive" src="{{URL::asset('Dashbord/img/Laboratory_Employee/'.$image->fileame)}}" alt="NoImg">
                </a>
            </li>
            @endforeach
        </ul>
