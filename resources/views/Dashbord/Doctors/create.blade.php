...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"> {{trans('Doctors.Dectors')}}</h4><span
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select multiple="multiple" class="testselect2" name="appointments[]">
                                        <option selected  selected disabled>-- حدد المواعيد --</option>
                                        @foreach($appointments as $appointment)
                                            <option  value="{{$appointment->id}}">{{$appointment->translations[0]->name}}</option>
                                        @endforeach
                                    </select>
