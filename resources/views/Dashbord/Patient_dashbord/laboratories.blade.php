...
@section('title')
    {{trans('Dashbord/main-sidebar_trans.sections')}}
@stop
@section('css')
                                               ...
                                               <tr>
                                                   ...
                                                   <td>
                                                       @if($laboratorie->employee_id !== null)
                                                           <a class="btn btn-primary btn-sm" href="{{route('Patient_details.show',$laboratorie->id)}}" role="button">عرض التحليل</a>
                                                       @endif                                                   </td>
                                               </tr>
                                           @endforeach
                                            </tbody>
