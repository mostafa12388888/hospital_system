...
@section('title')
    {{$section->name}} / {{trans('Dashbord/Section/SectionTable_Trans.section_Doctors')}}
@stop
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{$section->name}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/{{trans('Dashbord/Section/SectionTable_Trans.section_Doctors')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
