    ...
    <table class="table text-md-nowrap" id="example1" data-page-length="50"style="text-align: center">
        ...
        @foreach ($group_invoices as $group_invoice)
            <tr>
                ...
                <td>{{ number_format($group_invoice->discout_Value, 2) }}</td>
                ...
                <td>
                    ...
                    <button wire:click="print({{ $group_invoice->id }})" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print"></i></button>
                </td>
            </tr>
